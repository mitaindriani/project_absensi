...
<body>
  <div class="container">
    ...
    <form action="update.php" method="POST">
        ...
        <div class="mb-3">
              <ol for="mapel" class="form-control">Mapel</ol>
