                ...
                <form method="POST" action="save_jam_kerja.php">
                    ...
                    ?>
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col">
                                    <input type="time" class="form-control" id="<?php echo strtolower($day); ?>_masuk" name="<?php echo strtolower($day); ?>_masuk" value="<?php echo $jam_masuk; ?>">
                                </div>
                                <div class="col">
                                    <input type="time" class="form-control" id="<?php echo strtolower($day); ?>_pulang" name="<?php echo strtolower($day); ?>_pulang" value="<?php echo $jam_pulang; ?>">
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
